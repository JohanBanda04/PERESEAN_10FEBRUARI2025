                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user"
                     ...
                     stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                        ...
                        <select name="kode_divisi_pilihan" id="kode_divisi_pilihan"
                            ...
                            <option value="all_berita">SEMUA BERITA</option>
                            @php
                                $getall_divisi = DB::table('divisi')->get();

                            @endphp
                            @foreach($getall_divisi as $key=>$d)
                                <option value="{{ $d->kode_divisi }}">
                ...
                <div class="col-12">
                    <div class="form-group">
                        <input type="submit" class=" btn btn-primary w-100"
                               value="Download (.docx) Laporan Whatssap Anda">
                    </div>
                </div>
            </div>
        </form>
...
<script>
    $(function () {
        ...
        $('#frmGenereteWaTodayKanwil').submit(function () {
            ...
            var kode_divisi_pilihan = $('#frmGenereteWaTodayKanwil').find('#kode_divisi_pilihan').val();
            ...
            if (id_konfig == "") {
                ...
                Swal.fire({
                    title: 'Warning!',
                    text: 'Anda Belum Memilih Divisi',
                    icon: 'warning',
                    confirmButtonText: 'Ok'
                }).then((result) => {
                    $('#kode_divisi_pilihan').focus();
                });
                return false;
            }
