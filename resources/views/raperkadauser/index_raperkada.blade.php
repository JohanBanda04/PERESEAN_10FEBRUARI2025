                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="#" class="editberita btn-sm"
                                                           ...
                                                           color: white; margin-left: 9px;"
                                                           id_berita="{{--{{ $d->id_berita }}--}}" title="Edited By Perancang?">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <a href="#" class="editberita btn-sm"
                                                           style="background-color: #1e35bc; border-radius: 5px;
                                                           color: white; margin-left: 8px;"
                                                           id_berita="{{--{{ $d->id_berita }}--}}" title="Edited By Pemda?">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 class="icon icon-tabler icon-tabler-edit" width="24"
                                                                 height="24" viewBox="0 0 24 24" stroke-width="2"
                                                                 stroke="currentColor" fill="none"
