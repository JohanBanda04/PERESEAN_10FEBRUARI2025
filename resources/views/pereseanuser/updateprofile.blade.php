                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    @php
                                        //$explode = explode('_',$pereseanuser->roles);
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="modal-content" style="">
                                        ...
                                        <div class="modal-body " style="">
                                            <form action="{{ route('profilepereseanuser.updatepassworduser', $pereseanuser->kode_pereseanuser) }}"
                                                  method="post" id="frmUpdatePasswordPereseanuser"
                                                  name="frmUpdatePasswordPereseanuser"
                                         ...
                                         stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                                                ...
                                                d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"/>
                                                            ...
                                                            <input readonly type="text"
                                                                   value="{{ $pereseanuser->nama_lengkap }}"
                                                                   class="form-control"
                                                                   name="pereseanuser_namalengkap"
                                                                   id="pereseanuser_namalengkap"
                                                                   placeholder="Nama Lengkap">

                                                            <input readonly type="hidden"
                                                                   value="{{ $pereseanuser->kode_pereseanuser }}"
                                                                   class="form-control"
                                                                   name="pereseanuser_kodeuser"
                                                                   id="pereseanuser_kodeuser"
                                         ...
                                         class="icon icon-tabler icons-tabler-outline icon-tabler-key"><path
                                                ...
                                                d="M15 9h.01"/></svg>
                                                            ...
                                                            <input type="password" autocomplete="off" value=""
                                                                   class="form-control"
                                                                   name="password_lamauser"
                                                                   id="password_lamauser"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         ...
                                         class="icon icon-tabler icons-tabler-outline icon-tabler-key"><path
                                                ...
                                                d="M15 9h.01"/></svg>
                                                            ...
                                                            <input type="password" autocomplete="off" value=""
                                                                   class="form-control"
                                                                   name="password_baruuser"
                                                                   id="password_baruuser"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         ...
                                         class="icon icon-tabler icons-tabler-outline icon-tabler-key"><path
                                                ...
                                                d="M15 9h.01"/></svg>
                                                            ...
                                                            <input type="password" autocomplete="off" value=""
                                                                   class="form-control"
                                                                   name="konfirmasi_password_baruuser"
                                                                   id="konfirmasi_password_baruuser"
        ...
        @push('myscript')
            <script>
                $(function () {
                    ...
                    $('#frmUpdatePasswordPereseanuser').submit(function () {
                        var password_lamauser = $('#frmUpdatePasswordPereseanuser').find('#password_lamauser').val();
                        var password_baruuser = $('#frmUpdatePasswordPereseanuser').find('#password_baruuser').val();
                        var konfirmasi_password_baruuser = $('#frmUpdatePasswordPereseanuser').find('#konfirmasi_password_baruuser').val();


                        if (password_lamauser == "") {
                            ...
                            Swal.fire({
                                ...
                                $('#password_lamauser').focus();
                            });
                            return false;
                        } else if (password_baruuser == "") {
                            //alert("NIK Harus Diisi");
                            Swal.fire({
                                title: 'Warning!',
                                ...
                                $('#password_baruuser').focus();
                            });
                            return false;
                        } else if (konfirmasi_password_baruuser == "") {
                            //alert("NIK Harus Diisi");
                            Swal.fire({
                                title: 'Warning!',
                                ...
                                $('#konfirmasi_password_baruuser').focus();
                            });
                            return false;
