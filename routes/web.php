...
use App\Http\Controllers\AuthPereseanController;
use App\Http\Controllers\CabangController;
use App\Http\Controllers\DashboardController;
use App\Http\Controllers\DashboardPereseanController;
use App\Http\Controllers\DatadivisiController;
use App\Http\Controllers\DatapenggunaController;
use App\Http\Controllers\DataraperkadaController;
...
//ROUTE PERESEAN DARI SINI
/*hanya bisa diakses oleh guest*/
Route::middleware(['guest:tbl_user'])->group(function(){
    Route::get('/',function(){
        return view('authview.loginperesean');
    })->name('loginperesean');
    Route::post('/prosesloginperesean', [AuthPereseanController::class, 'prosesloginperesean'])->name('prosesloginperesean');

});

/*hanya utk satker yang terotentikasi*/
Route::middleware(['auth:tbl_user', 'checkrole'])->group(function () {
    //Dashboard PERESEAN
    //Route::get('/proseslogoutperesean', [AuthPereseanController::class, 'proseslogoutsatker'])->name('proseslogoutsatker');
    Route::get('/panelperesean/logoutperesean', [AuthPereseanController::class, 'logoutperesean'])->name('logoutperesean');
    Route::get('/panelperesean/dashboardperesean', [DashboardPereseanController::class, 'dashboardperesean'])->name('dashboardperesean');

    Route::get('/panelperesean/datapengguna', [DatapenggunaController::class, 'index'])->name('datapengguna')->middleware('admin');
    Route::post('/panelperesean/store', [DatapenggunaController::class, 'pereseanuserstore'])->name('pereseanuserstore');
    Route::post('/panelperesean/edit', [DatapenggunaController::class, 'pereseanuseredit'])->name('pereseanuser.edit');
    Route::post('/panelperesean/{id_user}/update', [DatapenggunaController::class, 'pereseanuserupdate'])->name('pereseanuser.update');
    Route::post('/panelperesean/{id_user}/delete', [DatapenggunaController::class, 'pereseanuserdelete'])->name('pereseanuserdelete');

    //Data Raperkada ETC
    Route::get('/panelperesean/{kode_pereseanuser}/getraperkada', [DataraperkadaController::class, 'getraperkada'])->name('getraperkada');

    Route::get('/panelperesean/{kode_pereseanuser}/gantipassworduser', [DatapenggunaController::class, 'gantipassworduser'])->name('gantipassworduser');
    Route::post('/panelperesean/{kode_pereseanuser}/updatepassworduser', [DatapenggunaController::class, 'updatepassworduser'])->name('profilepereseanuser.updatepassworduser');

});
//ROUTE PERESEAN SAMPAI SINI
